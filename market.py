...
def get_product_list(page, campaign_id, access_token):
    ...
    Returns:
        dict: Содержимое ответа API Яндекс Маркета.
    
    Examples:
        dict1 = {
            "paging" : dict - Токены предыдущей и следующей страниц,
            "offerMappingEntries": list - Массив словарей, содержащих информацию о товарах. Включает не более 200 объектов,
        } 
    """    
...
def update_price(prices, campaign_id, access_token):
    ...
    Args:
        prices (list): Массив данных о стоимости товаров.
        campaign_id (str): Идентификатор кампании в API и магазина в кабинете. 
        access_token (str): Авторизационный токен API.
...
def get_offer_ids(campaign_id, market_token):
    ...
    Returns:
        list: Список артикулов всех товаров магазина на Яндекс Маркет.
    """    
    page = ""
    product_list = []
    while True:
...
def create_stocks(watch_remnants, offer_ids, warehouse_id):
    ...
    Args:
        ...
        offer_ids (list): Список артикулов всех товаров магазина на Яндекс Маркет.
        warehouse_id (str): Идентификатор склада Маркета
        
    Returns:
        list: Массив, включающий артикулы товаров, ID складов и информацию об остатках.
    """    
...
def create_prices(watch_remnants, offer_ids):
    ...
    Returns:
        list: Массив, включающий артикулы товаров, и информацию об их стоимости.
    """    
    prices = []
    for watch in watch_remnants:
        if str(watch.get("Код")) in offer_ids:
...
async def upload_stocks(watch_remnants, campaign_id, market_token, warehouse_id):
    ...
    Returns:
        list: Фильтрованный массив, включающий информацию только о товарах с ненулевым остатком: артикулы, ID складов и информацию об остатках.
        list: Массив, включающий артикулы всех товаров, ID складов и информацию об остатках.
    """    
    offer_ids = get_offer_ids(campaign_id, market_token)
